(function() {
    ...
    define('jade!app/text/comment', function() {
        var fn = function template(locals) {
            ...
            var jade_interp;;
            var locals_for_with = (locals || {});
            (function(comment, conf, bool, i18n, humanize, datetime, svg) {
                ...
                buf.push("<a href=\"#\" class=\"reply\">" + (jade.escape((jade_interp = i18n('comment-reply')) == null ? '' : jade_interp)) + "</a><a href=\"#\" class=\"edit\">" + (jade.escape((jade_interp = i18n('comment-edit')) == null ? '' : jade_interp)) + "</a><a href=\"#\" class=\"delete\">" + (jade.escape((jade_interp = i18n('comment-delete')) == null ? '' : jade_interp)) + "</a></div><div class=\"isso-follow-up\"></div></div></div>");
            }("comment" in locals_for_with ? locals_for_with.comment : typeof comment !== "undefined" ? comment : undefined, "conf" in locals_for_with ? locals_for_with.conf : typeof conf !== "undefined" ? conf : undefined, "bool" in locals_for_with ? locals_for_with.bool : typeof bool !== "undefined" ? bool : undefined, "i18n" in locals_for_with ? locals_for_with.i18n : typeof i18n !== "undefined" ? i18n : undefined, "humanize" in locals_for_with ? locals_for_with.humanize : typeof humanize !== "undefined" ? humanize : undefined, "datetime" in locals_for_with ? locals_for_with.datetime : typeof datetime !== "undefined" ? datetime : undefined, "svg" in locals_for_with ? locals_for_with.svg : typeof svg !== "undefined" ? svg : undefined));;
            return buf.join("");
        };
        return fn;
    });
    ...
    define('jade!app/text/comment-loader', function() {
        var fn = function template(locals) {
            ...
            var jade_interp;;
            var locals_for_with = (locals || {});
            (function(comment, pluralize) {
                buf.push("<div" + (jade.attr("id", 'isso-loader-' + (comment.name) + '', true, false)) + " class=\"isso-comment-loader\"><a href=\"#\" class=\"load_hidden\">" + (jade.escape((jade_interp = pluralize('comment-hidden', comment.hidden_replies)) == null ? '' : jade_interp)) + "</a></div>");
            }("comment" in locals_for_with ? locals_for_with.comment : typeof comment !== "undefined" ? comment : undefined, "pluralize" in locals_for_with ? locals_for_with.pluralize : typeof pluralize !== "undefined" ? pluralize : undefined));;
            return buf.join("");
        };
        return fn;
    });
    ...
    */
    ...
    define('app/isso', ["app/dom", "app/utils", "app/config", "app/api", "app/jade", "app/i18n", "app/lib", "app/globals"],
        function($, utils, config, api, jade, i18n, lib, globals) {
            ...
            var insert_loader = function(comment, lastcreated) {
                ...
                var el = $.htmlify(jade.render("comment-loader", {
                    "comment": comment
                }));
     ...
     */
     mainfun = function(domready, config, i18n, api, isso, count, $, css, svg, jade) {
